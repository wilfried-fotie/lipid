...
class DropdownFormField<T> extends StatefulWidget {
  ...
  final ListTile Function(T item, int position, bool focused, bool selected,
      Function() onTap, String selectedItem) dropdownItemFn;
...
class DropdownFormFieldState<T> extends State<DropdownFormField>
          ...
          child: FormField(
            ...
            builder: (state) {
              return InputDecorator(
                  ...
                  child: Text(_selectedItem.toString() == "null"
                      ? widget.initialValue
      ...
      return Positioned(
        ...
        child: CompositedTransformFollower(
          ...
          child: Material(
              elevation: 4.0,
              child: SizedBox(
                height: widget.dropdownHeight ?? 290,
                child: Container(
  ...
  _setValue() {
    ...
    widget.onChanged(_selectedItem.toString());
